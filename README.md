...
- [x] **Stores data in MongoDB** - I set up a MongoDB database that stores habit data for each user.
- [x] **Stores credentials in MongoDB** - I store username and password info in MongoDB.
